...
def command(request_text=''):
    ...
    if request_text == '1':
        print(bcolors.WARNING, "[gRPC] gRPC.startSTT sttMode: ", sttMode, " channel: ", channel, " sampleFmt: ", sampleFmt, " sampleRate: ", sampleRate, bcolors.ENDC)    
        gRPC.startSTT(sttMode, sampleFmt, sampleRate, channel, onError)

    elif request_text == '2':
        fileContent = None
        filePath = "./TestFile/GRPC.pcm"
